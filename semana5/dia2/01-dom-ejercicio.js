...
const llenarUsuarios = () => {
    ...
    // 3.en cada iteracion sumar al string del paso 1 un tr con 5 td's con la data del objeto usuario
    // 4.luego de todas las iteraciones, hacer un innerHTML con el string creado
